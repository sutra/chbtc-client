...
import org.oxerr.chbtc.dto.Balance;
import org.oxerr.chbtc.dto.Depth;
import org.oxerr.chbtc.dto.Order;
import org.oxerr.chbtc.dto.Result;
...
public class CHBTCAdapters {
	...
	public static Trades adaptTrades(org.oxerr.chbtc.dto.Trade[] trades,
			CurrencyPair currencyPair) {
		List<Trade> tradeList = new ArrayList<>(
				trades.length);
		for (org.oxerr.chbtc.dto.Trade trade : trades) {
	...
	public static AccountInfo adaptAccountInfo(
			org.oxerr.chbtc.dto.AccountInfo accountInfo) {
	...
	private static Trade adaptTrade(
			org.oxerr.chbtc.dto.Trade trade, CurrencyPair currencyPair) {
		return new Trade(

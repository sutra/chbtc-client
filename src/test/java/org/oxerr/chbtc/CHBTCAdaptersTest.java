...
public class CHBTCAdaptersTest {
	...
	public void testAdpatOrderBook() throws IOException {
		Depth depth = mapper.readValue(getClass().getResource("dto/depth.json"), Depth.class);
	...
	public void testAdaptTradesOrder() throws IOException {
		Order order = mapper.readValue(getClass().getResource("dto/order.json"), Order.class);
